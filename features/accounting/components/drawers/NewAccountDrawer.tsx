...
export function NewAccountDrawer({
  ...
  return (
    <div className="drawer-overlay" onClick={onClose} aria-modal="true" role="dialog">
      <div className="drawer-panel max-w-lg w-full" onClick={(e) => e.stopPropagation()}>
        <div className="drawer-header border-b pb-3 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-gray-900">Nueva Cuenta PUC Colombia</h2>
        ...
        <form onSubmit={handleSubmit} className="drawer-body space-y-3 py-3 text-xs">
          <div>
