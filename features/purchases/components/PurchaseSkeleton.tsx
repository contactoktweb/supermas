...
export function PurchaseStatsSkeleton() {
  return (
        ...
        <tbody>
          {[1, 2, 3, 4, 5].map((row) => (
            <tr key={row} className="skeleton-pulse">
              <td><div className="skeleton-line" style={{ width: 90, height: 16 }} /></td>
              <td><div className="skeleton-line" style={{ width: 80, height: 16 }} /></td>
              <td><div className="skeleton-line" style={{ width: 75, height: 16 }} /></td>
              ...
              <td><div className="skeleton-line" style={{ width: 80, height: 16 }} /></td>
              <td><div className="skeleton-line" style={{ width: 90, height: 22, borderRadius: 12 }} /></td>
              <td><div className="skeleton-line" style={{ width: 80, height: 16 }} /></td>
