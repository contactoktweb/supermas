...
interface UserToastProps {
  toasts: UserToastMessage[]
  onDismiss: (id: string) => void
}

export function UserToastContainer({ toasts, onDismiss }: UserToastProps) {
...
function ToastItem({ toast, onDismiss }: { toast: UserToastMessage; onDismiss: () => void }) {
  useEffect(() => {
