...
export interface TaxToastMessage {
  id: string
...
interface TaxToastProps {
  toasts: TaxToastMessage[]
  onDismiss: (id: string) => void
}

export function TaxToastContainer({ toasts, onDismiss }: TaxToastProps) {
...
function ToastItem({ toast, onDismiss }: { toast: TaxToastMessage; onDismiss: () => void }) {
  useEffect(() => {
