...
class AccountingRepository {
  ...
  /**
   * Mapeo de cuentas contables por categoría de inventario
   */
  private categoryMappings: InventoryAccountMapping[] = [
    ...
    },
    {
      ...
      inventoryAccountName: 'Inventario - Lácteos y Refrigerados',
    ...
    },
    {
      ...
      inventoryAccountName: 'Inventario - Aseo y Cuidado del Hogar',
    ...
    },
    {
      ...
      inventoryAccountName: 'Inventario - Bebidas y Confitería',
