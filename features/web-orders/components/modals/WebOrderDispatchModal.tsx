      ...
      >
        ...
        <div className="p-5 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 m-0">Despacho de Mercancía</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="p-3.5 rounded-xl bg-sky-50 border border-sky-200 text-xs text-sky-900">
            ...
            <ul className="list-disc pl-4 mt-1 space-y-0.5 text-[11px]">
              ...
              <li>Actualizará el estado a <strong>SHIPPED (Enviado)</strong> con trazabilidad en auditoría.</li>
            </ul>
          </div>
          ...
          <div className="flex justify-end gap-2 pt-3 border-t border-slate-200">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-4 py-2 rounded-lg bg-sky-600 text-white font-semibold text-xs hover:bg-sky-700 disabled:opacity-50 transition-colors flex items-center gap-1.5"
            >
