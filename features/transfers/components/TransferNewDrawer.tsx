      ...
      >
        ...
        <div className="drawer-header product-detail-header-v2">
          <div className="product-detail-hero-layout">
            ...
            <div>
              <span className="product-category-eyebrow">Asistente de Movimiento Interno</span>
              <h2 className="product-title-heading" style={{ fontSize: 18, margin: '2px 0 0' }}>
        ...
        <div className="detail-tab-body" style={{ paddingTop: 18 }}>
            ...
            <div className="wizard-step-content page-enter">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                ...
                >
                  ...
                  {originLocation && (
                    <div className="location-meta-box" style={{ marginTop: 12, background: '#f8fafc', padding: 10, borderRadius: 6, fontSize: 11 }}>
                ...
                >
                  <label style={{ display: 'block', fontSize: 11, fontWeight: 700, textTransform: 'uppercase', color: 'var(--navy)', marginBottom: 6 }}>
                  ...
                  {destinationLocation && (
                    <div className="location-meta-box" style={{ marginTop: 12, background: '#eff6ff', padding: 10, borderRadius: 6, fontSize: 11 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
          ...
          {step === 2 && (
            <div className="wizard-step-content page-enter">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                <div>
                  <h4 style={{ margin: 0, fontSize: 14, color: 'var(--navy)' }}>
                ...
                <span className="count-tag-pill">{selectedItems.length} producto(s) en orden</span>
              </div>

              {/* Product Catalog Search */}
              <div className="search-box wide products-search-box" style={{ marginBottom: 12 }}>
                      ...
                      >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                            ...
                            <div>
                              <strong style={{ fontSize: 12, display: 'block', color: 'var(--text-main)' }}>
                                {prod.productName}
                              </strong>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            <button
                              ...
                              style={{ fontSize: 10, padding: '3px 6px', color: '#64748b' }}
                              title="Ver existencias en otras bodegas"
                            >
                              <AppIcon name="warehouse" size={11} />
                              <span>{isExpanded ? 'Ocultar sedes' : 'Otras sedes'}</span>
                            </button>
              ...
              <h5 style={{ margin: '14px 0 8px', fontSize: 13, color: 'var(--navy)' }}>
              ...
              {selectedItems.length === 0 ? (
                ...
                >
                  <AppIcon name="products" size={24} style={{ opacity: 0.5, marginBottom: 4 }} />
                    ...
                    <table>
                      <thead>
                        <tr>
                          ...
                          <th style={{ textAlign: 'center', width: 110 }}>Cant. a Transferir</th>
            ...
            <div className="wizard-step-content page-enter">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 16 }}>
                <div className="stat-card" style={{ padding: 12 }}>
                  <span style={{ fontSize: 10, color: 'var(--muted)' }}>Bodega Origen</span>
                ...
                <div className="stat-card" style={{ padding: 12, borderColor: 'var(--navy)' }}>
                  <span style={{ fontSize: 10, color: 'var(--navy)', fontWeight: 700 }}>Bodega Destino</span>
                  <strong style={{ fontSize: 13, display: 'block', color: 'var(--navy)' }}>
                ...
                <div className="stat-card" style={{ padding: 12 }}>
                  <span style={{ fontSize: 10, color: 'var(--muted)' }}>Total Artículos</span>
                  <strong style={{ fontSize: 18, color: 'var(--navy)' }}>{selectedItems.length} SKUs</strong>
                </div>

                <div className="stat-card" style={{ padding: 12 }}>
                  <span style={{ fontSize: 10, color: 'var(--muted)' }}>Total Unidades</span>
                  <strong style={{ fontSize: 18, color: 'var(--green)' }}>{totalUnits} uds</strong>
                </div>
              </div>
          ...
          {/* =========================================================================
             ...
             ========================================================================= */}
          {step === 4 && (
            <div className="wizard-success-view page-enter" style={{ textAlign: 'center', padding: '30px 20px' }}>
              <div
                style={{
                  width: 64,
                  height: 64,
              ...
              <span className="count-tag-pill" style={{ background: '#eff6ff', color: 'var(--navy)', marginBottom: 8 }}>
                Orden Generada
              </span>
              <h3 style={{ fontSize: 20, color: 'var(--navy)', margin: '8px 0' }}>
